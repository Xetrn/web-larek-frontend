 ...
 */
export function getElementData<T>(
  el: HTMLElement,
  scheme: Record<string, (value: string) => T[keyof T]>
): T {
...
export const disableScrollOnElement = (element: HTMLElement) => {
...
export const enableScrollOnElement = (element: HTMLElement) => {
