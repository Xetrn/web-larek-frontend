...
IUser: тип данных для представления информации о пользователе для оформления заказа:
...
- order: IUser - объект заказа, содержащий текущие данные, введённые пользователем.
